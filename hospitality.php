	...
	<div class="history agileits-1">
     ...
     <div class="container">
       <div class="row">
         ...
         <div class="col-lg-8" >
           The hospitality team of ELAN-2017 upholds the code of conduct 'Atithi Devo Bhavah'. In ELAN, we ensure that you celebrate undiluted awesomeness while we take care of the rest. We assure that your short stay with us will be fun, secure and comfortable. Our team will be available round the clock to address your every need. 
            <br><br>
...
Buses will be provided on the days of the festival. Specific bus details will be updated by 17th Jan 2017.
                  <br>
                  <br><h2>ACCOMMODATION DETAILS</h2>
...
<span class="glyphicon glyphicon-star"></span>&nbsp;&nbsp;&nbsp;Safety deposit of INR 200 has to be paid at the registration desk. It would be reimbursed at the time of check out. 
            ...
            <br><br>      <h2 style="margin-left: -55px;">RULES</h2>
      <div style="text-align: left;"  >
